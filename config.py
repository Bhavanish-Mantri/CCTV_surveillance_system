...
Edit values here — no hardcoding anywhere else.
"""
...
# Face recognition
# ---------------------------------------------------------------------------
FACE_DISTANCE_THRESHOLD   = float(os.getenv("FACE_THRESHOLD", 0.6))    # 0.6 = recommended default
FRAME_RESIZE_SCALE        = float(os.getenv("FRAME_SCALE", 0.5))     # higher = better accuracy
PROCESS_EVERY_N_FRAMES    = int(os.getenv("PROCESS_N_FRAMES", 2))    # every 2nd frame
